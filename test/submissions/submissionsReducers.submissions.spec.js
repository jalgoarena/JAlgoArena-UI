...
let SUBMISSION_JULIA = new Submission("fib", 0.01, "class Dummy", "ACCEPTED", "0-0", "1", new Date("2018", "3", "5"), 0, 1, 0);
let SUBMISSION_MIKOLAJ = new Submission("fib", 0.01, "class Dummy", "ACCEPTED", "0-1", "2", new Date("2018", "3", "5"), 0, 1, 0);
